...
app.post('/sort', (req, res) => {
  ...
  }else if (sortType === 'tas') {
    command = path.join(__dirname, 'tripartas');
  }else if (sortType === 'selection') {
    command = path.join(__dirname, 'triparselection');
  }else if (sortType === 'cocktail') {
    command = path.join(__dirname, 'tricocktail');
  }else if (sortType === 'shell') {
    command = path.join(__dirname, 'trideshell');
  }else if (sortType === 'gnome') {
    command = path.join(__dirname, 'trignome');
  }else if (sortType === 'count') {
    command = path.join(__dirname, 'tricount');
  }
